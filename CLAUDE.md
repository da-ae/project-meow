...
@.claude/rules/project_meow_summary.md - PRD: 「야옹아, 내가 집사라도 괜찮을까?」 인터랙티브 랜딩 페이지 기획서
@.claude/rules/ux-flow.md - UX Flow: 챕터별 플로우, 인터랙션, 필요 컴포넌트 정의
...
### 프로젝트 「야옹아」 작업 시
1. `project_meow_summary.md`에서 전체 기획/컨셉/기술스택 확인
2. `ux-flow.md`에서 해당 챕터의 플로우, 인터랙션, 필요 컴포넌트 확인
3. 인터랙티브 맵/미니게임 구현 시 UX 규칙(힌트 타이밍, 실패 처리 등) 준수
